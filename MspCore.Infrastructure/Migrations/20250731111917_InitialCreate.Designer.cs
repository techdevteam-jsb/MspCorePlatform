...
namespace MspCore.Infrastructure.Migrations
{
    ...
    [Migration("20250731111917_InitialCreate")]
            ...
            modelBuilder.Entity("MspCore.Domain.Entities.Cmdb.CmdbBaseItem", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CmdbBaseItem");
            ...
            modelBuilder.Entity("MspCore.Domain.Entities.Cmdb.CmdbConfigurationItem", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CmdbConfigurationItem");
                });
            ...
            modelBuilder.Entity("MspCore.Domain.Entities.Cmdb.CmdbApplicationItem", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CmdbApplicationItem");
                });
            ...
            modelBuilder.Entity("MspCore.Domain.Entities.Cmdb.CmdbClientItem", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CmdbClientItem");
                });
            ...
            modelBuilder.Entity("MspCore.Domain.Entities.Cmdb.CmdbCompanyItem", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CmdbCompanyItem");
                });
            ...
            modelBuilder.Entity("MspCore.Domain.Entities.Cmdb.CmdbProductItem", b =>
                {
                    ...
                    b.ToTable("CmdbBaseItems", "public", t =>
                        {
                            t.Property("ReleaseDate")
                                .HasColumnName("CmdbProductItem_ReleaseDate");

                            t.Property("Version")
                                .HasColumnName("CmdbProductItem_Version");
                        });

                    b.HasDiscriminator().HasValue("CmdbProductItem");
                });
